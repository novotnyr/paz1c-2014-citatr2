 ...
 * @author ppatrik
 */
public class SerializujuciCitatDao implements CitatDao {

    private List<Citat> citaty = new LinkedList<Citat>();

    private long dalsieId = 1;

    public SerializujuciCitatDao() {
    ...
    public static CitatDao loadFromFile(File file) throws IOException {
        CitatDao citatDao = new SerializujuciCitatDao();
    ...
    public List<Citat> dajVsetky() {
        return Collections.unmodifiableList(this.citaty);
    }
